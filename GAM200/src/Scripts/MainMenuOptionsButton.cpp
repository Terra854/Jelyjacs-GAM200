...
MainMenuOptionsButton::MainMenuOptionsButton(std::string name) : LogicScript(name)
{
...
/*********************************************************************/
void MainMenuOptionsButton::Start(Object* obj) {
    executeOnPause = true;
...
// @param obj: The object to which this script is attached.
/*********************************************************************/
void MainMenuOptionsButton::Shutdown(Object* obj) {
    std::cout << "ButtonBase Script Shutdown : " << obj->GetName() << std::endl;
}

// Creating an instance of ButtonBase.
MainMenuOptionsButton mainMenuOptionsButton("MainMenuOptionsButton");