...
This file contains the script for fullscreen button in pause menu
...
void FullscreenButton::Update(Object* obj) {
    ...
    if (obj == nullptr || objectFactory->FindLayerThatHasThisObject(obj) == nullptr || !objectFactory->FindLayerThatHasThisObject(obj) || !objectFactory->FindLayerThatHasThisObject(obj)->second.first.isVisible) {
